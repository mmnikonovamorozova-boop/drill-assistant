...
def login_screen():
    ...
    with st.container(border=True):
        ...
        with col_reg3:
            ...
            "Татнефть": [
                "ПАО Татнефть", "ООО Татнефть-Самара", "ООО Татнефть-НАО", "ООО Севергеология"
            ],
            "Независимые компании (Выбор из списка)": [
            ...
            "Новая компания (Ввод вручную)": [
                "Ввести параметры компании вручную"
            ]
        }
