...
def login_screen():
    ...
    vink_database = {}
    vink_database["Газпром (Газовые ДО)"] = ["ООО Газпром добыча Уренгой", "ООО Газпром добыча Ямбург", "ООО Газпром недра"]
    vink_database["Газпром нефть"] = ["ООО Газпромнефть-Хантос", "ООО Газпромнефть-Ноябрьскнефтегаз", "АО Мессояханефтегаз"]
