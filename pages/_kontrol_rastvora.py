...
with st.expander("🔐 Реестр легитимности и Интерактивная верификация ПО"):
    ...
    # Математически верный расчет индекса течения Гершеля-Балкли по ГОСТ/API с учетом τ0 в СИ
    v_n_hb = 3.32 * math.log10((v_theta_600 - (v_f_yp * 0.1)) / (v_theta_300 - (v_f_yp * 0.1))) if (v_theta_300 - (v_f_yp * 0.1)) > 0 else 0.5
