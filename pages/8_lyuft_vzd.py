...
with st.expander("🔰 Паспорт верификации стандартов СТО ИНТИ", expanded=False):
    ...
    st.markdown("""
    * **Контроль осевого люфта:** Измерение фактического зазора опорного узла шпинделя ВЗД перед спуском. Превышение порога — критическое основание для отбраковки ДВС.
    * **Контроль радиального зазора:** Обязательный инструментальный замер нижнего радиального подшипника (втулки) для исключения биения долота.
    * **Метрологический аудит:** Использование поверенных индикаторов часового типа (ИЧ) и калиброванного инструмента на буровой площадке.
    * **Предотвращение аварий:** Регистрация фактического износа в журнале наработки для защиты КНБК и элементов телесистемы от опасных вибраций.
    """)
