...
with st.expander("🔰 Паспорт верификации стандартов СТО ИНТИ", expanded=False):
    ...
    st.markdown("Полный перечень требований (контроль износа, критерии отбраковки, метрология замеров и регистрация отказов) доступен в исходных стандартах и материалах.")
