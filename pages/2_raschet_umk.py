...
if "keys_db" not in st.session_state:
    st.session_state.keys_db = {
        "УМК-10/1 (L = 0.615 м | зажим Ø 89-114 мм)", 
        "УМК-35 (L = 0.900 м | зажим Ø 114-168 мм)", 
        "УМК-48 (L = 1.100 м | зажим Ø 146-245 мм)", 
        "УМК-75 (L = 1.400 м | зажим Ø 168-324 мм)",
        "УМК-90 (L = 1.400 м | зажим Ø 168-324 мм)",
    }
