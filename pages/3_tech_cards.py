...
def load_tech_cards_database():
    ...
    # Структурированная база техкарт без калькуляторов и дублирующих заглушек
    fallback_data = {
        ...
        "Ликвидация затяжек и прихватов (Р-ТС-19)": {
            ...
            "recommendations": [
                "Для КНБК с ВЗД-172 выдерживать щадящий расход 26-30 л/с, для ВЗД-240 – 46-48 л/с во избежание гидроразрыва пласта.",
        ...
        "Борьба с вибрациями КНБК (И-ТС-55)": {
            ...
            "verification_route": [
                ...
                {"step": "При 2-м уровне (желтый) известить супервайзера и бурового мастера; при 3-м уровне (красный) — немедленно остановить бурение", "role": "Инженер по бурению"},
