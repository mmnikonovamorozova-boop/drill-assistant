...
accuracy_pct = 75.0
# =========================================================================
# БЛОК 4.3: ЭКСПЕРТНАЯ СИСТЕМА - ЧАСТЬ 3.1 (ИСПРАВЛЕННАЯ ФИЛЬТРАЦИЯ БАЗЫ)
# =========================================================================
...
# =========================================================================
# БЛОК 4.4: ЭКСПЕРТНАЯ СИСТЕМА - ЧАСТЬ 3.2 (ОБУЧЕНИЕ МОДЕЛИ СЛУЧАЙНОГО ЛЕСА)
# =========================================================================
...
if len(df_train) >= 3:
    try:
        ...
        model_ready = False
# =========================================================================
# БЛОК 4.5: ЭКСПЕРТНАЯ СИСТЕМА - ЧАСТЬ 3.3 (АНАЛИТИЧЕСКИЙ СТАТИЧЕСКИЙ ОТКАТ)
# =========================================================================
