...
with st.expander("🔰 Паспорт верификации СТО ИНТИ", expanded=False):
    ...
    st.markdown("""
    * **Моделирование деградации эластомеров:** Математический учет скорости старения нитрильных обкладок (NBR) статора бурового мотора под воздействием циклических нагрузок.
