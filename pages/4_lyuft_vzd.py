...
# Нормативная плашка СТО ИНТИ, скрытая под спойлер
with st.expander("📄 СТО ИНТИ: Верификация соответствия"):
    st.markdown(
        "<div style='color: #4B5563; font-size: 13px; background-color: #F3F4F6; padding: 8px; border-radius: 4px; border-left: 3px solid #1E3A8A;'> "
        "Модуль соответствует СТО ИНТИ S.QS.7 (п. 7.4.3, 7.5.1) и S.QS.8 (п. 5.7.2) "
        "по проверке критических параметров и контролю измерительного инструмента."
        "</div>",
